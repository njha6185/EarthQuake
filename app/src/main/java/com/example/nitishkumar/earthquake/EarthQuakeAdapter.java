...
public class EarthQuakeAdapter extends ArrayAdapter<EarthQuake>{
    ...
    public View getView(int position,  View convertView, ViewGroup parent) {
        ...
        {
            listItemView = LayoutInflater.from(getContext()).inflate(R.layout.earth_quake_list_itm, parent, false);
        }
        EarthQuake currentEarthQuakeItem = getItem(position);

        TextView magnitudeView = (TextView)listItemView.findViewById(R.id.magnitude);
        magnitudeView.setText(formatMagnitude(currentEarthQuakeItem.getmMagnitude()));

        GradientDrawable magnitudeCircle = (GradientDrawable)magnitudeView.getBackground();
        int magnitudeColor = getMagnitudeColor(currentEarthQuakeItem.getmMagnitude());
        magnitudeCircle.setColor(magnitudeColor);

        String originalLocation = currentEarthQuakeItem.getmLocation();
    ...
    private int getMagnitudeColor(double value) {
        int magValue = (int)Math.floor(value);
